...
plt.style.use('/home/Fuzz4All/tools/coverage/style.mplstyle')
#plt.style.use(
   # 'https://github.com/dhaitz/matplotlib-stylesheets/blob/master/pitayasmoothie-light.mplstyle'
...
def plot_c_full_run():
    ...
    folders = [
        ...
        f"{BASE_DIR}full_run/c-change/std_2",
        f"{BASE_DIR}full_run/c-change/std_3",
        f"{BASE_DIR}full_run/c-change/std_4",
        f"{BASE_DIR}full_run/c-change/std_5",
    ]
...
def plot_cpp_full_run():
    ...
    folders = [
        ...
        f"{BASE_DIR}full_run/cpp-change/cpp_23_2",
        f"{BASE_DIR}full_run/cpp-change/cpp_23_3",
        f"{BASE_DIR}full_run/cpp-change/cpp_23_4",
        f"{BASE_DIR}full_run/cpp-change/cpp_23_5",
    ]
...
def plot_smt_full_run():
    ...
    folders = [
        ...
        f"{BASE_DIR}full_run/smt2-change/general_strategy_3",
        f"{BASE_DIR}full_run/smt2-change/general_strategy_4",
        f"{BASE_DIR}full_run/smt2-change/general_strategy_5",
    ]
    points = []
    for folder in folders:
        with open(f"{folder}/coverage.csv", "r") as f:
...
def plot_go_full_run():
    ...
    folders = [
        ...
        f"{BASE_DIR}full_run/go-change/run_3",
        f"{BASE_DIR}full_run/go-change/run_4",
        f"{BASE_DIR}full_run/go-change/run_5",
    ]
    points = []
    new_time = [i for i in range(1, 25)]
    new_time.insert(0, 0.5)
...
def plot_qiskit_full_run():
    ...
    folders = [
        ...
        f"{BASE_DIR}/full_run/qiskit-change/run_opt_and_qasm",
        f"{BASE_DIR}/full_run/qiskit-change/run_opt_and_qasm_2",
        f"{BASE_DIR}/full_run/qiskit-change/run_opt_and_qasm_4",
        f"{BASE_DIR}/full_run/qiskit-change/run_opt_and_qasm_5",
    ]
    ...
    for folder in folders:
        ...
        line_cov = [x * 92430 for _, x in sorted(zip(time, line_cov))]
        # time is just
